...
<?php 
$consulta_roles = $con->prepare("SELECT id, nombre FROM tipos_usuario WHERE nombre IN ('Vigilante', 'Numerario')");
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-outline mb-4">
                            <label for="tipo_usuario" class="nav-link"><i class="fas fa-user"></i> &nbsp;<strong>Tipo Usuario </strong></label>
